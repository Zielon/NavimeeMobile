...
public class SheetLayout extends FrameLayout {
    ...
    private void init() {
        inflate(getContext(), com.github.fabtransitionactivity.R.layout.bottom_sheet_layout, this);
        mFabExpandLayout = ((LinearLayout) findViewById(com.github.fabtransitionactivity.R.id.ft_container));
    }
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        theme.resolveAttribute(com.github.fabtransitionactivity.R.attr.colorPrimary, outValue, true);

        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                attrs,
                com.github.fabtransitionactivity.R.styleable.FooterLayout,
                0, 0);

        int containerGravity;
        try {
            setColor(a.getColor(com.github.fabtransitionactivity.R.styleable.FooterLayout_ft_color,
                    outValue.data));
            animationDuration = a.getInteger(com.github.fabtransitionactivity.R.styleable.FooterLayout_ft_anim_duration,
                    DEFAULT_ANIMATION_DURATION);
            containerGravity = a.getInteger(com.github.fabtransitionactivity.R.styleable.FooterLayout_ft_container_gravity, 1);
            mFabSize = a.getInteger(com.github.fabtransitionactivity.R.styleable.FooterLayout_ft_fab_type, DEFAULT_FAB_SIZE);
        } finally {
            a.recycle();
        }
